...
LANGUAGE_DICTIONARY <- list(
  ...
  es = list(
    ...
    receive_personalized_feedback = "Reciba retroalimentación personalizada sobre sus respuestas",
    ...
    no_personal_identifiers = "Sin identificadores personales ni información de contacto",
  ...
  erasure = "Borrado: Solicitar la eliminación de sus datos",
  ...
  complaint = "Queja: Presentar una queja ante las autoridades supervisoras",
    ...
    analysis_completed = "Análisis psicométrico avanzado completado con reportes específicos por dominio",
    ...
    consent_purpose_text = " Este estudio investiga las habilidades cognitivas usando elementos de evaluación estandarizados. Sus respuestas serán anonimizadas y usadas solo para propósitos de investigación.",
    consent_privacy_label = "Privacidad de Datos:",
    consent_privacy_text = " Todos los datos se almacenan de forma segura y se manejan de acuerdo con las pautas institucionales y del GDPR.",
    ...
    consent_checkbox_text = "He leído y entendido la información anterior y consiento participar.",
    ...
    instructions_cognitive_tasks = "Completará una serie de tareas cognitivas que evalúan memoria, velocidad y función ejecutiva.",
    ...
    instructions_no_right_wrong = "No hay respuestas correctas o incorrectas; por favor haga lo mejor que pueda.",
  ...
  complaint = "Plainte : Déposer une plainte auprès des autorités de contrôle",
    welcome_text = "Veuillez fournir vos détails démographiques pour commencer l'évaluation.",
    ...
    items_administered = "Éléments Complétés",
    ...
    # Consent section
    consent_title = "Consentement de l'Étude de Recherche",
    ...
    consent_purpose_label = "Objectif:",
    consent_purpose_text = " Cette étude enquête sur les capacités cognitives en utilisant des éléments d'évaluation standardisés. Vos réponses seront anonymisées et utilisées uniquement à des fins de recherche.",
    consent_privacy_label = "Confidentialité des Données:",
    consent_privacy_text = " Toutes les données sont stockées en toute sécurité et traitées conformément aux directives institutionnelles et au RGPD.",
    ...
    instructions_cognitive_tasks = "Vous compléterez une série de tâches cognitives évaluant la mémoire, la vitesse et la fonction exécutive.",
    ...
    demographics_optional_info = "Veuillez fournir des informations optionnelles sur vous-même. Tous les champs sont optionnels et vous pouvez ignorer toute question que vous préférez ne pas répondre.",
    ...
    welcome_description = "Votre participation aide à faire avancer la science cognitive. Toutes les données sont confidentielles et utilisées uniquement pour la recherche académique.",
    ...
    legal_basis_for_processing = "Base légale pour le traitement",
    ...
    support_and_concerns = "Support et préoccupations",
    ...
    institution = "Institution",
    study_purpose_label = "Objectif de l'étude",
    publication = "Publication",
    risks = "Risques",
    benefits = "Avantages",
    ...
    address = "Adresse",
    email = "E-mail",
    data_protection_officer = "Responsable de la protection des données",
    supervisory_authority = "Autorité de surveillance",
    
    # Error handling
    error_title = "Erreur",
    error_message = "Une erreur s'est produite. Veuillez réessayer.",
    error_boundary_title = "Erreur Système",
    error_boundary_message = "Une erreur inattendue s'est produite. Votre progression a été sauvegardée. Veuillez contacter le support si ce problème persiste.",
    error_recovery_button = "Essayer de Récupérer",
    error_contact_support = "Contacter le Support",
    error_retry_button = "Réessayer",
    error_continue_button = "Continuer",
    error_restart_button = "Redémarrer l'Évaluation",
    error_save_progress = "Sauvegarder la Progression",
    error_load_progress = "Charger la Progression",
    system_error = "Erreur Système"
  ),
  
  # Add error handling labels to all languages
  en = c(LANGUAGE_DICTIONARY$en, list(
    # Error handling
    error_title = "Error",
    error_message = "An error occurred. Please try again.",
    error_boundary_title = "System Error",
    error_boundary_message = "An unexpected error occurred. Your progress has been saved. Please contact support if this problem persists.",
    error_recovery_button = "Try to Recover",
    error_contact_support = "Contact Support",
    error_retry_button = "Retry",
    error_continue_button = "Continue",
    error_restart_button = "Restart Assessment",
    error_save_progress = "Save Progress",
    error_load_progress = "Load Progress",
    system_error = "System Error"
  )),
  
  de = c(LANGUAGE_DICTIONARY$de, list(
    # Error handling
    error_title = "Fehler",
    error_message = "Ein Fehler ist aufgetreten. Bitte versuchen Sie es erneut.",
    error_boundary_title = "Systemfehler",
    error_boundary_message = "Ein unerwarteter Fehler ist aufgetreten. Ihr Fortschritt wurde gespeichert. Bitte kontaktieren Sie den Support, wenn dieses Problem weiterhin besteht.",
    error_recovery_button = "Versuchen zu Wiederherstellen",
    error_contact_support = "Support Kontaktieren",
    error_retry_button = "Wiederholen",
    error_continue_button = "Weiter",
    error_restart_button = "Bewertung Neustarten",
    error_save_progress = "Fortschritt Speichern",
    error_load_progress = "Fortschritt Laden",
    system_error = "Systemfehler"
  )),
  
  es = c(LANGUAGE_DICTIONARY$es, list(
    # Error handling
    error_title = "Error",
    error_message = "Ha ocurrido un error. Por favor, inténtelo de nuevo.",
    error_boundary_title = "Error del Sistema",
    error_boundary_message = "Ha ocurrido un error inesperado. Su progreso ha sido guardado. Por favor, contacte al soporte si este problema persiste.",
    error_recovery_button = "Intentar Recuperar",
    error_contact_support = "Contactar Soporte",
    error_retry_button = "Reintentar",
    error_continue_button = "Continuar",
    error_restart_button = "Reiniciar Evaluación",
    error_save_progress = "Guardar Progreso",
    error_load_progress = "Cargar Progreso",
    system_error = "Error del Sistema"
  )),
  
  fr = c(LANGUAGE_DICTIONARY$fr, list(
    # Error handling
    error_title = "Erreur",
    error_message = "Une erreur s'est produite. Veuillez réessayer.",
    error_boundary_title = "Erreur Système",
