---
title: "Getting Started with Non-Adaptive Assessments in inrep"
...
output:
  html_document:
    ...
    css: styles.css
vignette: >
  %\VignetteIndexEntry{Getting Started with Non-Adaptive Assessments in inrep}
...
# Welcome to inrep
This vignette shows how to run a fixed-form (non-adaptive) assessment using **inrep**. It covers creating a study configuration, launching a Shiny study, and exporting responses.

For adaptive testing examples, see \code{adaptive-assessments-getting-started.Rmd}.
...
Based on the University of Hildesheim HilFo study, here are examples of how to create research assessments.

### Bilingual Research Study (Like HilFo)

This example shows how to create a bilingual study with multiple assessment types:
...
# Define demographics (German/English bilingual)
...
# Define  demographics for students
...
## Core Functions and Operational Notes
...
1. Include informed consent text appropriate for your study.
2. If you provide participant-facing reports, consider making them optional and word them carefully.
3. If you run multilingual studies, enable language switching and validate translations.
4. Set up reverse coding for negatively worded items and verify the scoring.
5. Validate the item bank structure before running a study.
6. Decide whether to enable session save/restore based on your deployment model.
7. Export data in the formats you need (CSV/JSON/RDS).
8. Test the UI in the browsers/devices you expect participants to use.
