...
launch_study(research_config, bfi_items)
```
...
launch_study(education_config, math_items)
```
...
launch_study(clinical_config, bfi_items)  # Using bfi_items as example
```
...
launch_study(academic_config, bfi_items)
```
...
### Some practices I would recommend for Assessments so far
