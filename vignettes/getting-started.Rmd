...
The **inrep** package is a framework for creating and administering adaptive assessments using Item Response Theory (IRT) models. Whether you're an educator, researcher, or assessment professional, inrep provides the tools you need to create adaptive tests with minimal effort.
...
config <- create_study_config(
  ...
  estimation_method = "EAP",        # Use TAM for estimation
...
advanced_config <- create_study_config(
  ...
  model = "2PL",
  estimation_method = "EAP",        # Use TAM (MIRT will be added later)
  max_items = 20,
  min_items = 8,
