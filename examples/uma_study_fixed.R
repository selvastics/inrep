# =============================================================================
# UMA STUDY - FIXED VERSION - FULL INREP COMPATIBILITY
# =============================================================================
...
# =============================================================================
# ITEM BANK - FIXED WITH REQUIRED COLUMNS
# =============================================================================
all_items <- data.frame(
  ...
  # CRITICAL: Add ResponseCategories for 7-point scale
  ResponseCategories = rep("1,2,3,4,5,6,7", 30),
  # CRITICAL: Add IRT parameters for GRM model
  a = rep(1.0, 30),  # Discrimination parameters
  b = rep(0.0, 30),  # Difficulty parameters
...
# =============================================================================
# STUDY CONFIGURATION - ENHANCED FOR FULL COMPATIBILITY
# =============================================================================
study_config <- inrep::create_study_config(
  ...
  # CRITICAL: Set model to GRM for 7-point scale
  model = "GRM",
