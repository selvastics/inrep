...
ONBOARDING_I18N <- list(
  en = list(
    ...
    q_pages_tip     = "Tip: adaptive studies typically use 10–20, fixed studies 5–30.",
  ...
  de = list(
    ...
    q_pages_tip     = "Tipp: Adaptive Studien nutzen meist 10–20, Fixe Studien 5–30.",
  ...
  es = list(
    ...
    q_pages_tip     = "Consejo: los estudios adaptativos usan 10–20, los fijos 5–30.",
  ...
  fr = list(
    ...
    q_pages_tip     = "Conseil : les études adaptatives utilisent 10–20, les fixes 5–30.",
...
ob_css <- function() {
  tags$style(HTML("
    ...
    * { box-sizing: border-box; }
    ...
    .ob-hero-brand { display: flex; align-items: baseline; gap: 0; margin-bottom: 0; }
...
@media (max-width: 600px) {
      ...
      .ob-hero-logo svg {
        width: min(190vw, 680px) !important;
        height: auto !important;
        display: block;
        margin-bottom: -10px;
      }
...
ob_step_pages <- function(state, t) {
  cur_val <- as.integer(state$max_items %||% 10L)
  tagList(
    tags$div(class = "ob-body",
