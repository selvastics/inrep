...
TRANSLATIONS <- list(
  de = list(
    ...
    welcome_text1 = "In den Übungen zu den statistischen Verfahren wollen wir mit anschaulichen Daten arbeiten, die von Ihnen selbst stammen. Deswegen wollen wir ein paar Dinge von Ihnen erfahren.",
    welcome_text2 = "Da wir verschiedene Auswertungen ermöglichen wollen, deckt der Fragebogen verschiedene Themenbereiche ab, die voneinander teilweise unabhängig sind.",
    welcome_privacy = "Ihre Angaben sind dabei selbstverständlich anonym",
    welcome_privacy_detail = "es wird keine personenbezogene Auswertung der Daten stattfinden. Die Daten werden von den Erstsemestern Psychologie im Bachelor generiert und in diesem Jahrgang genutzt, möglicherweise auch in späteren Jahrgängen.",
    welcome_instructions = "Im Folgenden werden Ihnen dazu Aussagen präsentiert. Wir bitten Sie anzugeben, inwieweit Sie diesen zustimmen. Es gibt keine falschen oder richtigen Antworten. Bitte beantworten Sie die Fragen so, wie es Ihrer Meinung am ehesten entspricht.",
