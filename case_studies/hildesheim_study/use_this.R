...
custom_page_flow <- list(
  ...
  list(
    ...
    content = paste0(
      ...
      'if (el.tagName !== "SCRIPT" && el.tagName !== "STYLE" && !el.classList.contains("action-button") && !el.classList.contains("btn") && el.id !== "next_page") {',
      ...
      'if (btnText) btnText.textContent = currentLang === "en" ? "Deutsche Version" : "English Version";',
      '// Trigger inrep language system',
      'if (typeof Shiny !== "undefined" && Shiny.setInputValue) {',
      'Shiny.setInputValue("study_language", currentLang, {priority: "event"});',
      '}',
      '// Also trigger translation for dynamic content',
      'setTimeout(function() { translatePage(); }, 100);',
      'setTimeout(function() { isToggling = false; }, 1000);',
      '};',
