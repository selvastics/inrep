...
custom_js <- paste0(
  ...
  "node.textContent=text.replace(new RegExp(de.replace(/[.*+?^${}()|[\\]\\\\]/g,'\\\\$&'),'g'),translations[de]);",
  "break;",
  "}",
  "}",
  "}else{",
  ...
  "node.textContent=text.replace(new RegExp(en.replace(/[.*+?^${}()|[\\]\\\\]/g,'\\\\$&'),'g'),de);",
  "break;",
  "}",
  "}",
  "}",
  ...
  "if(currentLang==='en'){",
  "for(var de in translations){",
  "if(val===de){el.value=translations[de];break;}",
  "}",
  "}else{",
  "for(var de in translations){",
  "if(val===translations[de]){el.value=de;break;}",
  "}",
  "}",
  "}",
  "if(el.placeholder){",
  ...
  "if(currentLang==='en'){",
  "for(var de in translations){",
  "if(ph===de){el.placeholder=translations[de];break;}",
  "}",
  "}else{",
  "for(var de in translations){",
  "if(ph===translations[de]){el.placeholder=de;break;}",
  "}",
  "}",
  "}",
  "}",
  ...
  "if(currentLang==='en'){setTimeout(translatePage,50);}",
  "});",
