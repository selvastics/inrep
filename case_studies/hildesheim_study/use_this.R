...
custom_page_flow <- list(
  ...
  list(
    ...
    content = paste0(
      ...
      # JavaScript for language switching with content toggle
      '<script>',
      'var currentLang = "de";',
      'var isToggling = false;',
      'function toggleLanguage() {',
      'console.log("BUTTON CLICKED! Current lang:", currentLang);',
      'if (isToggling) {',
      'console.log("Still toggling, skipping");',
      'return;',
      '}',
      'isToggling = true;',
      ...
      'console.log("DE content found:", !!deContent);',
      'console.log("EN content found:", !!enContent);',
      'if (currentLang === "en") {',
      'console.log("Switching to English");',
      'if (deContent) {',
      'deContent.style.display = "none";',
      'console.log("Hidden German content");',
      '}',
      'if (enContent) {',
      'enContent.style.display = "block";',
      'console.log("Shown English content");',
      '}',
      '} else {',
      'console.log("Switching to German");',
      'if (deContent) {',
      'deContent.style.display = "block";',
      'console.log("Shown German content");',
      '}',
      'if (enContent) {',
      'enContent.style.display = "none";',
      'console.log("Hidden English content");',
      '}',
      '}',
      '// Update button text',
      'var btn = document.querySelector("button[onclick=\\"toggleLanguage()\\"]");',
      'console.log("Button found:", !!btn);',
      'if (btn) {',
      'var newText = currentLang === "en" ? "Deutsche Version" : "English Version";',
      ...
      '// Test if elements exist on page load',
      'document.addEventListener("DOMContentLoaded", function() {',
      'console.log("DOM loaded - checking elements:");',
      'console.log("content_de exists:", !!document.getElementById("content_de"));',
      'console.log("content_en exists:", !!document.getElementById("content_en"));',
      '});',
      '</script>',
      ...
      '</div>',
      '</div>',
      # JavaScript for checkbox syncing
      '<script>',
