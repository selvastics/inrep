...
custom_js <- paste0(
  ...
  "      if(el.placeholder){",
  "        for(var de in translations){",
  "          if(el.placeholder === de){",
  "            el.placeholder = translations[de];",
  "            break;",
  "          }",
  "        }",
  "      }",
  "    }",
  "  }else{",
  "    // GERMAN MODE - Replace all English with German",
  ...
  "  ",
  "  // Call translation function multiple times to ensure everything is translated",
  "  translateEverything();",
