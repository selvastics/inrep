...
custom_page_flow <- list(
  ...
  list(
    ...
    content = paste0(
      ...
      'if (currentLang === "en") {',
      'console.log("Applying comprehensive English translations...");',
      'for (var de in translations) {',
      'var germanText = de;',
      'var englishText = translations[de];',
      'document.querySelectorAll("*").forEach(function(el) {',
      'if (el.tagName !== "SCRIPT" && el.tagName !== "STYLE" && el.textContent) {',
      'if (el.textContent.includes(germanText)) {',
      'console.log("Translating:", germanText.substring(0, 30), "->", englishText.substring(0, 30));',
      'el.innerHTML = el.innerHTML.replace(new RegExp(germanText, "g"), englishText);',
      '}',
      '}',
      '});',
      '}',
      ...
      'setTimeout(function() {',
      'console.log("Triggering comprehensive translation...");',
      'translatePage();',
      'setTimeout(function() { translatePage(); }, 1000);',
      'setTimeout(function() { translatePage(); }, 2000);',
      '}, 200);',
      '} else {',
