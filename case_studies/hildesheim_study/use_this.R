...
custom_page_flow <- list(
  ...
  list(
    ...
    content = paste0(
      ...
      # Simple JavaScript for language switching
      '<script>',
      'var currentLang = "de";',
      'function toggleLanguage() {',
      'console.log("BUTTON CLICKED! Switching language...");',
      'currentLang = currentLang === "de" ? "en" : "de";',
      'console.log("Language switched to:", currentLang);',
      '// Toggle content divs',
      'var deDiv = document.getElementById("content_de");',
      'var enDiv = document.getElementById("content_en");',
      'if (currentLang === "en") {',
      'if (deDiv) deDiv.style.display = "none";',
      'if (enDiv) enDiv.style.display = "block";',
      '} else {',
      'if (deDiv) deDiv.style.display = "block";',
