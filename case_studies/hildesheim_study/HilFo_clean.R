    ...
    custom_js = "
      ...
      window.toggleLanguage = function() {
        ...
        buttons.forEach(function(btn) {
          if (btn) {
            btn.textContent = (window.hilfoLanguage === 'en') ? 'Deutsche Version' : 'English Version';
          }
        });
      ...
      document.addEventListener('DOMContentLoaded', function() {
        setTimeout(function() {
          if (!document.querySelector('.hilfo-lang-button')) {
            ...
            btn.innerHTML = '<button onclick=\"toggleLanguage()\" style=\"background: #e8041c; color: white; border: none; padding: 8px 16px; border-radius: 4px; cursor: pointer; font-weight: bold;\"><span class=\"lang-switch-text\">English Version</span></button>';
            document.body.appendChild(btn);
          }
        }, 100);
      });
